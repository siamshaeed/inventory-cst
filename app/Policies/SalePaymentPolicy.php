...
class SalePaymentPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, SalePayment $salePayment)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, SalePayment $salePayment)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, SalePayment $salePayment)
    {
        //
    }
