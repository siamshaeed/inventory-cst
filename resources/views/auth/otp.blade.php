        ...
        <div class="form-part">
            ...
            <p class="user-num">
                ...
                <span class="text-danger text-end">
                    &nbsp; &nbsp; <b>{{ \Illuminate\Support\Facades\Session::get('msg_error') }}</b>
                </span>
                                        ...
                                        {{--<form class="text-center">--}}
                                            <div class="form-group reset-form-group">
                                                <div class="passcode-wrapper">
                                                    <input id="codeBox1" type="number" name="code_1" maxlength="1"
                                                        onkeyup="onKeyUpEvent(1, event)" onfocus="onFocusEvent(1)">
                                                    <input id="codeBox2" type="number" name="code_2" maxlength="1"
                                                        onkeyup="onKeyUpEvent(2, event)" onfocus="onFocusEvent(2)">
                                                    <input id="codeBox3" type="number" name="code_3" maxlength="1"
                                                        onkeyup="onKeyUpEvent(3, event)" onfocus="onFocusEvent(3)">
                                                    <input id="codeBox4" type="number" name="code_4" maxlength="1"
