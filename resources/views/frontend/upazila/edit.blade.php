...
<form class="mt-4" action="{{ route('upazila.update', $upazila->id) }}" method="post" >
    @csrf
    @method('put')
    <div class="mb-3 row">
        <label for="name" class="col-sm-2 col-form-label text-end">Name English</label>
        <div class="col-sm-10">
            <input type="text" id="name" value="{{$upazila->name}}" name="name" value="{{ old('name') }}" class="form-control" placeholder="Enter Division  Name English">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input type="text" id="name_bn" value="{{$upazila->bn_name}}" name="name_bn" value="{{ old('bn_name') }}" class="form-control" placeholder="Enter Division  Name Bangla">
