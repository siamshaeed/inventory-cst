        ...
        <div class="content-container">
            ...
            <div class="header d-flex justify-content-between">
                <div class="head-left d-flex">
                    <span></span>
                    <p class="mb-0 ms-1">
                        <a href="{{ route('district.index') }}" class="link" data-bs-toggle="tooltip" title="{{ __('District') }}">{{ __('District') }}</a>
                    </p>
                </div>
                <div class="head-right d-flex">
                    <button type="button" class="btn btn-sm btn-secondary show-modal"
                            data-route="{{route('district.create')}}"
                            data-method="get"
                            data-action="view"
                            data-toggle="tooltip"
                            data-modal_title="District"
                            title="Create New">
