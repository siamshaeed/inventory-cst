    ...
    <div class="mt-3">
        <div class="content-container">
            ...
            <div class="card-body pb-5 mb-3">
                <form class="mt-4" action="{{ route('product.store') }}" method="post" id="addFormData">
                    @csrf
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control" placeholder="Enter product name ..." required>
