        ...
        <div class="content-container">
            ...
            <div class="header d-flex justify-content-between">
                <div class="head-left d-flex">
                    <span></span>
                    <p class="mb-0 ms-1">
                        <a href="{{ route('stock.index') }}" class="link" data-bs-toggle="tooltip" title="{{ __('Stock Product View') }}">{{ __('Stock Product') }}</a>
                    </p>
                </div>
                <div class="head-right d-flex">
                    {{--<a href="{{ route('product.create') }}" class="ms-1 text-orange" data-bs-toggle="tooltip" title="Create New"><i class="fa fa-plus"></i> 2 Product</a>--}}
                    {{--@can('create')
