        ...
        <div class="content-container">
            ...
            <div class="header d-flex justify-content-between">
                <div class="head-left d-flex">
                    <span></span>
                    <p class="mb-0 ms-1">
                        <a href="{{ route('supplier.index') }}" class="link" data-bs-toggle="tooltip" title="{{ __('Supplier View') }}">{{ __('Supplier') }}</a>
                    </p>
                </div>
                <div class="head-right d-flex">
                    <button type="button" class="btn btn-sm btn-secondary show-modal"
                            data-route="{{ route('supplier.create') }}"
                            data-method="get"
                            data-action="view"
                            data-toggle="tooltip"
                            data-modal_title="Create Supplier"
                            title="Create New">
                ...
                <div class="table-responsive">
                    <table id="custom-table" class="table pt-3">
                        ...
                        <tr>
                            ...
                            <th scope="col">{{ __("Market Type") }}</th>
        ...
        $(document).ready( function () {
            $('#custom-table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'define_market_type_name', name: 'define_market_type_name'},
                    {data: 'name', name: 'name'},
