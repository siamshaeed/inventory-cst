...
<form class="mt-4" action="{{ route('supplier.update', $supplier) }}" method="post" id="addFormData">
    @csrf
    {{ method_field('PUT') }}
    ...
    <div class="col-md-10">
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <select name="market_type_id" class="form-control" required>
                    <option value="{{ $supplier->market_type_id }}" class="text-success" selected>{{ $supplier->market_type->name }}</option>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <input type="text" name="name" value="{{ old('name', $supplier->name) }}" class="form-control" placeholder="Enter supplier name" required>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <input type="text" name="title" value="{{ old('title', $supplier->title) }}" class="form-control" placeholder="Enter title">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <input type="number" name="phone" value="{{ old('phone', $supplier->phone) }}" class="form-control" placeholder="EX. 01 XXX XXX XXX" required>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <textarea name="address" class="form-control" cols="30" rows="3" placeholder="Write address ...">{{ old('address', $supplier->address) }}</textarea>
            </div>
        </div>
