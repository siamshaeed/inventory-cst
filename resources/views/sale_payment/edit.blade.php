        ...
        <div class="content-container">
            ...
            <div class="header d-flex justify-content-between">
                <div class="head-left d-flex">
                    <span></span>
                    <p class="mb-0 ms-1">
                        <a href="#" class="link" data-bs-toggle="tooltip" title="{{ __('Sale Due Payment ') }}">
                            {{ __('Sale Due Payment') }}
                        </a>
                    </p>
                </div>
                <div class="head-right d-flex">
                    <a href="{{ route('sale-payment.show', $sale) }}" class="ms-1 text-orange" data-bs-toggle="tooltip" title="View Sale Payment">
                        <i class="fa fa-home"></i> Sale Payment
                    </a>
                </div>
            </div>
            ...
            <div class="card-body pb-5 mb-3">
                ...
                <form class="mt-4" action="{{ route('sale-payment.update', $sale->id) }}" method="post">
                    @csrf
                    @method('put')
                        ...
                        <div class="mb-3 row d-none">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <dd class="col-sm-9">{{ $sale->total_amount }}</dd>

                                    <dt class="col-sm-3 text-end">Total Pay :</dt>
                                    <dd class="col-sm-9">{{ $sale->total_pay }}</dd>

                                    <dt class="col-sm-3 text-end">Total Due :</dt>
                                    <dd class="col-sm-9">{{ $sale->total_due }}</dd>
                                </div>
