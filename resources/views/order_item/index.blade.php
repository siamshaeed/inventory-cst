            ...
            <div class="header d-flex justify-content-between">
                <div class="head-left d-flex">
                    ...
                    <p class="mb-0 ms-1">
                        ...
                        Order Number: <b class="text-primary">{{ $order->order_number }}</b>; OrderName: <b class="text-success">{{ $order->supplier->name }}</b>
                    </p>
                </div>
                <div class="head-right d-flex">
                    <button type="button" class="btn btn-sm btn-secondary show-modal"
                            data-route="{{ route('order-item.create.order', $order_id) }}"
                            data-method="get"
                            data-action="view"
                            data-toggle="tooltip"
                ...
                <div class="table-responsive">
                    <table id="custom-table" class="table pt-3">
                        ...
                        <tr>
                            ...
                            <th scope="col" data-toggle="tooltip" title="Order Crated Date">{{ __("Order Date") }}</th>
    ...
    <script type="text/javascript">
        $(document).ready( function () {
            $('#custom-table').DataTable({
                ...
                autoWidth: true,
                responsive: true,
                ajax: '{{ route("order-item.show", $order_id) }}',
                columns: [
