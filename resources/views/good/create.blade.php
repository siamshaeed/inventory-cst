...
<form class="mt-4" action="{{ route('good.store') }}" method="post" id="addFormData">
    @csrf
    ...
    <div class="col-md-10">
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control" placeholder="Enter goods name" required>
