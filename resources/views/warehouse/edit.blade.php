...
<form class="mt-4" action="{{ route('warehouse.update', $warehouse) }}" method="post" id="addFormData">
    @csrf
    {{ method_field('PUT') }}
    ...
    <div class="col-md-10">
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <input type="text" id="name" name="name" value="{{ old('name', $warehouse->name) }}" class="form-control" placeholder="Enter warehouse name" required>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <input type="text" id="title" name="title" value="{{ old('title', $warehouse->title) }}" class="form-control" placeholder="Enter warehouse name">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <input type="text" id="address" name="address" value="{{ old('address', $warehouse->address) }}" class="form-control" placeholder="Enter warehouse Address">
