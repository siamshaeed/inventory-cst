        ...
        <div class="banner-overlay">
            <div class="container d-flex flex-column">
                <div class="blog-banner-content" style="height: 400px">
                    ...
                    <div class="route"><a href="">Home </a><span>/</span><a href="">News and Blogs</a></div>
                </div>
            </div>
        </div>
    </div>
    <div class="container section-margin">
        ...
        <div class="row blog-content">
            <div class="col-md-8 blog-left">
                <div class="blog-card d-flex direction">
                    <div class="blog-img">
                        <img src="{{ asset('images/blog1.jpg') }}" alt=""
                            onclick="location.href='{{ route('design.blog-details') }}'">
                    </div>
                    <div class="blog-details">
                        <div class="d-flex justify-content-between"
                            style="border-bottom: 1px solid #E8E8F5;padding: 20px 25px 15px 20px;">
                            <a href="{{ route('design.blog-details') }}">Get the best car service</a>
                            <div class="d-flex gap-2">
                                <img src="{{ asset('images/user2.jpg') }}" alt="" class="user-img">
                                <div>
                                    <p class="user mb-0">Admin</p>
                                    <span>17 Jan 2022</span>
                                </div>
                            </div>
                        </div>
                        <p class="section-details">Condimentum volutpat, feugiat quis massa, posuere sit potenti neque. Id
                            posuere sit mollis spien
                            amet, non. Egestas risus vitae ut sit....</p>
                    </div>
                </div>
                <div class="blog-card d-flex direction">
                    <div class="blog-img">
                    ...
                    <div class="blog-details">
                        <div class="d-flex justify-content-between"
                            style="border-bottom: 1px solid #E8E8F5;padding: 20px 25px 15px 20px;">
                            <a href="">Get the best car service</a>
                            <div class="d-flex gap-2">
                                <img src="{{ asset('images/user2.jpg') }}" alt="" class="user-img">
                                <div>
                                    <p class="user mb-0">Admin</p>
            ...
            <div class="col-md-4 blog-right">
                <div class="search-section" id="search">
                    ...
                    <div class="input-group">
                        ...
                        <button class="input-group-append search-btn">
                ...
                <div class="recent-blog">
                    ...
                    <div class="recent-blog-container">
                        <div class="d-flex gap-3 single-post">
                            <div class="post-img">
                                <img src="{{ asset('images/blog4.jpg') }}" alt="" onclick="location.href='{{ route('design.blog-details') }}'">
                            </div>
                            <div>
                                <a href="{{ route('design.blog-details') }}">Get the best car service</a>
