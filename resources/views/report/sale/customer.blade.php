        ...
        <div class="content-container">
            ...
            <div class="header d-flex justify-content-between">
                <div class="head-left d-flex">
                    <span></span>
                    <p class="mb-0 ms-1">
                        <a href="{{ route('report.sale.customer') }}" class="link" data-bs-toggle="tooltip" title="{{ __('Sale Customer View') }}">{{ __('Sale Customer Report') }}</a>
                    </p>
                </div>
                <div class="head-right d-flex">
                    ...
                    @if(!empty($sales))
                        <form class="col-md-3- mt-4- mb-4-" action="{{ route('report.sale.customer') }}" method="get">
            ...
            <div class="card-body pb-5">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <form class="mt-4 mb-4 col-md-9" action="{{ route('report.sale.customer') }}" method="get">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="col-sm-12">
                ...
                <div class="table-responsive">
                    <table id="custom-table" class="table pt-3">
                        ...
                        <tr>
                            ...
                            <th scope="col" data-tottle="tooltip" title="Product Name">{{ __("Customer Name") }}</th>
                        ...
                        @forelse($sales as $sale)
                            <tr>
                                ...
                                <td>{{ $sale->date }}</td>
                                <td>
                                    <a href="{{ route('report.sale.customerSlug', $sale->order->supplier->slug) }}" class="link">
                                        <b>{{ $sale->order->supplier->name }}</b>
                                    </a>
                                    <br>
                                    {{ $sale->order->supplier->market_type->name }}
                                </td>
                                <td>
