        ...
        <div class="content-container">
            ...
            <div class="header d-flex justify-content-between">
                <div class="head-left d-flex">
                    <span></span>
                    <p class="mb-0 ms-1">
                        <a href="{{ route('report.purchase.customer') }}" class="link" data-bs-toggle="tooltip" title="{{ __('Purchase Items View') }}">{{ __('Purchase Customer Report') }}</a>
                    </p>
                </div>
                <div class="head-right d-flex">
                    ...
                    @if(!empty($purchases))
                        <form class="col-md-3- mt-4- mb-4-" action="{{ route('report.purchase.customer') }}" method="get">
            ...
            <div class="card-body pb-5">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <form class="mt-4 mb-4 col-md-9" action="{{ route('report.purchase.customer') }}" method="get">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="col-sm-12">
                ...
                <div class="table-responsive">
                    <table id="custom-table" class="table pt-3">
                        ...
                        <tr>
                            ...
                            <th scope="col" data-tottle="tooltip" title="Supplier Name">{{ __("Supplier Name") }}</th>
                        ...
                        @forelse($purchases as $purchase)
                            <tr>
                                ...
                                <td>{{ $purchase->date}}</td>
                                <td title="Click to Details" data-toggle="tooltip">
                                    <a href="{{ route('report.purchase.customerSlug', $purchase->supplier->slug) }}" class="link text-decoration-none" target="_blank">
